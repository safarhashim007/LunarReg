...
print("===== ROMA FAST BIDIRECTIONAL EVALUATION =====")
print()
...
#
# This isolates whether bidirectional matching is useful
# independently of precise/high-resolution refinement.
# ---------------------------------------------------------
...
print("Experiment      : FAST + BIDIRECTIONAL")
print("Low resolution  :", model.H_lr, "x", model.W_lr)
print("High resolution :", model.H_hr)
...
print()
print("Running FAST BIDIRECTIONAL dense matching...")
...
#
# IMPORTANT:
# GeoTIFF information is ONLY used for evaluation.
#
# It is NOT used by RoMa to choose matches.
# =========================================================
...
# =========================================================
# LUNAR LON/LAT -> LRO EQUIRECTANGULAR METRES
# =========================================================
...
# =========================================================
# PROJECTED METRES -> EXPECTED LRO PIXELS
# =========================================================

inverse_lro = ~lro_transform
...
# =========================================================
# KEEP ONLY POINTS WHOSE EXPECTED LRO LOCATION IS VALID
# =========================================================
...
cv2.imwrite(
    f"{OUT}/roma_fast_bi_top_matches.png",
    canvas
)


# =========================================================
# VISUALIZE GEO-CORRECT <=10PX MATCHES
# =========================================================
...
cv2.imwrite(
    f"{OUT}/roma_fast_bi_correct_matches.png",
    correct_canvas
)
...
np.save(
    f"{OUT}/roma_fast_bi_ptsA.npy",
    ptsA
)


np.save(
    f"{OUT}/roma_fast_bi_ptsB.npy",
    ptsB
)


np.save(
    f"{OUT}/roma_fast_bi_expected_B.npy",
    expected_B
)


np.save(
    f"{OUT}/roma_fast_bi_errors.npy",
    errors
)


np.save(
    f"{OUT}/roma_fast_bi_confidence.npy",
    confidence
)
...
print(
    "Configuration : FAST + BIDIRECTIONAL"
)

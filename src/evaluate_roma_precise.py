...
# Precise mode is considerably heavier than fast mode.
N_MATCHES = 3000

# LRO lunar projection parameters
...
# ---------------------------------------------------------
# IMPORTANT:
# Use precise instead of fast.
#
# This enables higher-resolution processing/refinement
# and bidirectional matching.
# ---------------------------------------------------------

model.apply_setting("precise")

# Keep diverse sampling enabled.
model.balanced_sampling = True


print("Model ready.")
print()
print("Setting         : precise")
...
print()
print("Running PRECISE dense matching...")
print("This may take significantly longer than fast mode.")
...
# =========================================================
# LOAD GEOSPATIAL TRANSFORMS
#
# IMPORTANT:
# These are ONLY used to evaluate RoMa accuracy.
#
# They are NOT used to choose RoMa matches.
# =========================================================
...
# =========================================================
# CHANDRAYAAN PIXEL -> LONGITUDE / LATITUDE
# =========================================================
...
# =========================================================
# LONGITUDE / LATITUDE -> LRO PROJECTED METRES
# =========================================================
...
# =========================================================
# LRO PROJECTED METRES -> EXPECTED LRO PIXELS
# =========================================================
...
# =========================================================
# KEEP ONLY VALID GROUND-TRUTH LOCATIONS
# =========================================================
...
cv2.imwrite(
    f"{OUT}/roma_precise_top_matches.png",
    canvas
)


# =========================================================
# VISUALIZE GEO-CORRECT MATCHES
#
# Evaluation only.
# =========================================================
...
cv2.imwrite(
    f"{OUT}/roma_precise_correct_matches.png",
    correct_canvas
)
...
np.save(
    f"{OUT}/roma_precise_ptsA.npy",
    ptsA
)

np.save(
    f"{OUT}/roma_precise_ptsB.npy",
    ptsB
)

np.save(
    f"{OUT}/roma_precise_expected_B.npy",
    expected_B
)

np.save(
    f"{OUT}/roma_precise_errors.npy",
    errors
)

np.save(
    f"{OUT}/roma_precise_confidence.npy",
    confidence
)
